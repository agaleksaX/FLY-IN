...
def animate_simulation(
    ...
    for frame_idx, positions in enumerate(timeline):
        ...
        for drone_id, (x, y) in positions.items():
            if drone_id in drone_label_objects:
                txt = drone_label_objects[drone_id]
                ...
                drone_label_objects[drone_id] = txt

        active_ids = set(positions.keys())
        for drone_id, txt in drone_label_objects.items():
